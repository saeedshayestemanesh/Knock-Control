...
myPcurves_High= knockP(myTxs_High,myCdf_High,cyl,theta,'Fig'); hold all;
...
[M,Madv,Mret]= markovMx(myPcurve1,myPcurve1_High,m1,m2,m1_High,m2_High);    % M matrices for corresponding to this Pcurve / threshold
%[M,Madv,Mret]= markovMx(myPcurve1,m1,m2); 
